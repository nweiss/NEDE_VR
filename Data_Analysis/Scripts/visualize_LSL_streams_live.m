...
vis_stream('StreamName', 'iViewNG_HMD', 'DataScale', .5, 'ChannelRange', [1:37], 'TimeRange', 10, 'Position', [screen_width/2 + 15, 50, screen_width/2 - 25, screen_height/2]);

% Head Rotation
vis_stream('StreamName', 'Unity->Matlab', 'DataScale', 150, 'TimeRange', 10, 'Position', [1000, 50, 500, 300]);
%'ChannelRange', 1